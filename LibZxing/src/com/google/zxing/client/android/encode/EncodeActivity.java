...
public final class EncodeActivity extends AppCompatActivity {
    ...
    private void share() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.barcode_canner_title) + " - " + encoder.getTitle());
    ...
    protected void onResume() {
        ...
        try {
            ...
            if (intent.getBooleanExtra(Intents.Encode.SHOW_CONTENTS, true)) {
                ...
                setTitle(getString(R.string.barcode_canner_title) + " - " + qrCodeEncoder.getTitle());
            } else {
                contents.setText("");
